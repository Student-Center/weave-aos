...
data class MeetingListItemRes(
    ...
    val requestingTeam: MeetingListReceivingTeamRes,
    @SerializedName("receivingTeam")
    val receivingTeam: MeetingListRequestingTeamRest,
...
data class MeetingListReceivingTeamRes(
    @SerializedName("id")
    val id: String,
...
data class MeetingListRequestingTeamRest(
    @SerializedName("id")
    val id: String,
    @SerializedName("teamIntroduce")
    val teamIntroduce: String,
